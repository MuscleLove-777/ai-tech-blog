"""AI自動ブログ運営サービス - 管理ダッシュボード

FastAPIベースの管理画面。記事管理・統計・設定の閲覧が可能。
HTMLテンプレートはインライン文字列で定義（テンプレートファイル不要）。
"""
...
async def dashboard_top():
    """ダッシュボードトップページ - 記事統計・最新記事・スケジュール"""
...
async def article_detail(slug: str):
    ...
    <div class="table-wrap">
        ...
        <p style="font-size:12px;color:#94A3B8;margin-top:8px;">
            {len(meta_desc)} 文字（推奨: {META_DESCRIPTION_LENGTH}文字以内）
        </p>
    </div>
    ...
    <div class="settings-grid">
        <div class="setting-group">
            ...
            <div class="setting-row">
                <span class="label">ブログ名</span>
                <span class="value">{BLOG_NAME}</span>
            </div>
            <div class="setting-row">
                <span class="label">説明</span>
                <span class="value">{BLOG_DESCRIPTION}</span>
            </div>
            <div class="setting-row">
                <span class="label">URL</span>
                <span class="value">{BLOG_URL}</span>
            </div>
            <div class="setting-row">
                <span class="label">言語</span>
                <span class="value">{BLOG_LANGUAGE}</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            <h3>記事生成設定</h3>
            <div class="setting-row">
                <span class="label">文字数目安</span>
                <span class="value">{MAX_ARTICLE_LENGTH:,} 文字</span>
            </div>
            <div class="setting-row">
                <span class="label">1日の記事数</span>
                <span class="value">{ARTICLES_PER_DAY} 記事</span>
            </div>
            <div class="setting-row">
                <span class="label">対象カテゴリ</span>
                <span class="value">{cats_list}</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            <h3>SEO設定</h3>
            <div class="setting-row">
                <span class="label">最小キーワード密度</span>
                <span class="value">{MIN_KEYWORD_DENSITY}%</span>
            </div>
            <div class="setting-row">
                <span class="label">最大キーワード密度</span>
                <span class="value">{MAX_KEYWORD_DENSITY}%</span>
            </div>
            <div class="setting-row">
                <span class="label">メタ説明文の長さ</span>
                <span class="value">{META_DESCRIPTION_LENGTH} 文字</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            <h3>スケジューラー設定</h3>
            <div class="setting-row">
                <span class="label">投稿スケジュール</span>
                <span class="value">{hours_list}</span>
            </div>
            <div class="setting-row">
                <span class="label">ダッシュボードホスト</span>
                <span class="value">{DASHBOARD_HOST}</span>
            </div>
            <div class="setting-row">
                <span class="label">ダッシュボードポート</span>
                <span class="value">{DASHBOARD_PORT}</span>
            </div>
        </div>
    </div>
    """
...
async def api_generate(req: GenerateRequest):
    """記事生成API - キーワードとカテゴリを指定して記事を生成・保存"""
    try:
...
async def api_keywords(category: Optional[str] = Query(None)):
    """キーワード提案API - カテゴリを指定してキーワード候補を取得"""
    try:
        researcher = KeywordResearcher()
        suggestions = researcher.research_trending_keywords(category or "AI・機械学習")
        return {
            "status": "success",
            "category": category,
